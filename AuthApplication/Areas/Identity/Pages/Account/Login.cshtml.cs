...
namespace AuthApplication.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        {
            var properties = _signInManager.ConfigureExternalAuthenticationProperties("google", "/Home");
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var LMUser = _context.Users.FirstOrDefault(u=>u.Email==Input.Email);
                if (result.Succeeded && LMUser.EmailConfirmed)
                {
